...
let package = Package(
    ...
    dependencies: [
        .package(name: "WebRTC", url: "https://github.com/stasel/WebRTC.git", .upToNextMajor(from: "103.0.0")),
        ...
        .package(name: "SwiftPhoenixClient", url: "https://github.com/davidstump/SwiftPhoenixClient.git", .upToNextMajor(from: "4.0.0")),
